...
import { Store, TrendingUp, ArrowUpDown } from 'lucide-react';
...
export function MerchantAnalysis({ transactions, selectedCategory }: MerchantAnalysisProps) {
    ...
    const merchantStats = useMemo(() => {
        ...
        transactions
            ...
            .filter(t => t.customCategory !== 'Μισθοδοσία') // Exclude payroll/income
            .filter(t => !selectedCategory || (t.customCategory || 'Άλλο') === selectedCategory) // Category filter
            .forEach(t => {
                // Normalize name: Remove widely used prefixes if necessary or use counterparty
                // Logic: Use counterpartyName if available, else standard clean of description
        ...
        // Calculate averages and filter for >= 2 transactions
